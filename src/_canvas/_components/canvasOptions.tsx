...
export default function CanvasOptions({
  ...
  return (
    <>
      ...
      <div
        className={
          "w-full b-1 border border-foreground/10 mt-[0.2em] mb-[0.2em]"
        }
      />
      ...
      {activesShapes > 0 && (
        <div className={"flex flex-col gap-2 px-2"}>
          ...
          <div className={"grid grid-cols-3 place-items-center gap-2"}>
            <div
              role="button"
              onPointerDown={() => handleIndex("bottom")}
              className="flex relative px-2"
            >
              <Square />
              <Square className="absolute top-[0.3em] left-3 bg-accent" />
            </div>
            <div
              role="button"
              onPointerDown={() => handleIndex("above")}
              className="flex relative px-2"
            >
              <Square className="absolute top-[0.3em] left-3" />
              <Square className="z-20 bg-accent" />
            </div>

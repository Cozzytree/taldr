      ...
      <div className="sticky top-5 bg-background z-50 mb-9">
         <div className="px-3 py-2 button-group flex flex-wrap gap-1 border-b border-b-foreground/30">
            ...
            <Button
               ...
               className={
                  editor.isActive("paragraph") ? "bg-foreground/60" : ""
               }
            >
               Paragraph
            </Button>
            ...
            <Button
               ...
               className={
                  editor.isActive("bulletList") ? "bg-foreground/60" : ""
               }
            >
               <List />
            </Button>
            <Button
               ...
               className={
                  editor.isActive("orderedList") ? "bg-foreground/60" : ""
               }
            >
               <ListOrdered />
            </Button>
            <Button
               ...
               className={
                  editor.isActive("codeBlock") ? "bg-foreground/60" : ""
               }
            >
               <Code />
            </Button>
            <Button
               ...
               className={
                  editor.isActive("blockquote") ? "bg-foreground/60" : ""
               }
            >
               <Quote />
            </Button>
